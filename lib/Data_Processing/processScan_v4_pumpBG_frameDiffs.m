function ScanData = processScan_v4_pumpBG_frameDiffs(dataDir,ROIs3d,IMG_BG_det,IMG_BG_pump, imgCrop,outlierThreshold,useDifferences)
...
for tIndex = 1:NT
    ...
    imgs_t_P = readImagesInFolderSorted(directoryName,'* Probe*',imgSize)-BG_3d_det;
    imgs_t_PP = readImagesInFolderSorted(directoryName,'*Pump+Probe*',imgSize)-BG_3d_pump;
...
for tIndex = problemTimePoints
    ...
    directoryName = [dataDir, '\', backupDirectories(tIndex).name];
    imgs_t_P = readImagesInFolderSorted(directoryName,'* Probe*',imgSize)-BG_3d_det;
    imgs_t_PP = readImagesInFolderSorted(directoryName,'*Pump+Probe*',imgSize)-BG_3d_det;
