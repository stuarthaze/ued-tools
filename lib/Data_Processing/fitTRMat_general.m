function Fit = fitTRMat_general(dataMat,timeDelays,numExp,numSin,freqStart)
...
%-------------------------------------------------
% Fitting
fitFun = @(Pars) dataMat - params2matrix_gen(Pars);
