function ScanData = processScan_v2(dataDir,ROIs3d,IMG_BG,imgCrop,outlierThreshold)
...
BG_3d = zeros(NY_full,NX_full,numFrames);
...
for tIndex = 1:NT
    ...
    imgs_t_P = readImagesInFolder(directoryName,'* Probe*',imgSize)-BG_3d;
    imgs_t_PP = readImagesInFolder(directoryName,'*Pump+Probe*',imgSize)-BG_3d;
