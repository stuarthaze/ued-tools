function TR_data = processScan_IQR(dataDir,ROIs3d,IMG_BG,imgCrop,outlierRejectionThreshold)
...
for tIndex = 1:NT
    ...
    IMGs_P(:,:,tIndex) = fRemoveOutliersAndAverageIMG_IQR(imgs_t_p,outlierRejectionThreshold);
    IMGs_PP(:,:,tIndex) = fRemoveOutliersAndAverageIMG_IQR(imgs_t_pp,outlierRejectionThreshold);
