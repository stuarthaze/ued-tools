function OUT = saveCoordinates2view_v5(CRYSTAL, Refinement, k0_uvw, Displacements, saveDirectory)
...
writeXYZfile_v2(atomTypes,XYZ_GS_Cartesian,[savedir,'structures_GS.xyz']);
writeXYZfile_v2(atomTypes,XYZ_GS_cartesian_k0view,[savedir,'structures_GS_k0.xyz']);

for T = tIndices
    T
    XYZ_cartesian = XYZ_T(1:nAt,:,T);
	[XYZ_cartesian_k0_view, Tmat] = transformCoords_fromViewVector(XYZ_cartesian,k0_xyz,V_vert);
    writeXYZfile_v2(atomTypes,XYZ_cartesian,[savedir,'structures_fitted.xyz']);
    writeXYZfile_v2(atomTypes,XYZ_cartesian_k0_view,[savedir,'structures_fitted_k0.xyz']);
end
...
writeXYZfile_v2(atomTypes_311_supercell, XYZ_311_supercell_k0view, [savedir,'XYZ_311_super_k0.xyz']);
...
for T = tIndices
    ...
    writeXYZfile_v2(atomTypes_311_supercell, XYZ_T_super_k0view(:,:,T),[savedir, 'XYZ_T_super_k0.xyz']);
end
fclose('all');
end