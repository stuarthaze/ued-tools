function refinedStruct = refineStructure_v14(FED, CRYSTAL, MODEL)
% Changes: 
% v3
...
% v14
% Option to specify distances used for restraints Model.restraints.distList
...
if MODEL.restraints.useDistList
    DistListGS = MODEL.restraints.distList;
else
