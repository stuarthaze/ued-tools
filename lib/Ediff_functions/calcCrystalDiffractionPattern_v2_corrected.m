function IMG = calcCrystalDiffractionPattern_v2_corrected(EXPERIMENT,CRYSTAL,MODEL)
...
sigmaPar = MODEL.thetaParallel*modqIMG_L;
invSigmaPar2rd = 0.5./(sigmaPar.^2 + sigmaRad^2);
sigmaRot = MODEL.thetaRotation*modqIMG_L;
